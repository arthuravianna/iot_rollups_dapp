...
//var input_contract // can be used only as a promise
...
const input_contract_func = function(callback) {
    ...
    .then(function (result) { // result is Input contract address
        ...
        callback({success: true, value: input_contract}) //{success: true, value: input_contract}
    })
    .catch(function(error) {
        ...
        // console.log("############")
        callback({success: false, value: error_str})
    })
}
